...
```{r}
celltype1 <- predict_celltype(sce1)
celltype1[1:5, 1:3]
```
...
```{r}
celltype1 <- celltype1 %>%mutate(celltype_simple = fix_immgen_celltype(celltype1))
...
```{r}
celltype3 <- predict_celltype(sce1, name = "mca_spleen")
celltype3[1:5, 1:2]
```
